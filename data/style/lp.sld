...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ogc="http://www.opengis.net/ogc" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:se="http://www.opengis.net/se">
  <NamedLayer>
    <se:Name>LP_2020_A0_S0</se:Name>
    <UserStyle>
      <se:Name>LP_2020_A0_S0</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>0 - 8805</se:Name>
          <se:Description>
            <se:Title>0 - 8805</se:Title>
          </se:Description>
        ...
        <se:Rule>
          <se:Name>8805 - 31888</se:Name>
          <se:Description>
            <se:Title>8805 - 31888</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
        ...
        <se:Rule>
          <se:Name>31888 - 114057</se:Name>
          <se:Description>
            <se:Title>31888 - 114057</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThan>
              ...
              <ogc:PropertyIsLessThanOrEqualTo>
                <ogc:PropertyName>VALUE</ogc:PropertyName>
                <ogc:Literal>114057</ogc:Literal>
              </ogc:PropertyIsLessThanOrEqualTo>
            </ogc:And>
          </ogc:Filter>
          <se:PolygonSymbolizer>
        ...
        <se:Rule>
          <se:Name>114057 - 264155</se:Name>
          <se:Description>
            <se:Title>114057 - 264155</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThan>
              ...
              <ogc:PropertyIsLessThanOrEqualTo>
                <ogc:PropertyName>VALUE</ogc:PropertyName>
                <ogc:Literal>264155</ogc:Literal>
              </ogc:PropertyIsLessThanOrEqualTo>
            </ogc:And>
          </ogc:Filter>
          <se:PolygonSymbolizer>
        ...
        <se:Rule>
          <se:Name>264155 - 20261604</se:Name>
          <se:Description>
            <se:Title>264155 - 20261604</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThan>
              ...
              <ogc:PropertyIsLessThanOrEqualTo>
                <ogc:PropertyName>VALUE</ogc:PropertyName>
                <ogc:Literal>20261604</ogc:Literal>
              </ogc:PropertyIsLessThanOrEqualTo>
            </ogc:And>
          </ogc:Filter>
          <se:PolygonSymbolizer>
