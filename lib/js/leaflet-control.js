var map = L.map("map").setView([-12, -41.], 5);
...
//   .wms("http://engeosolucoes.com.br/geoserver/wms?", {
//     layers: "public:Blocos_Eploratorios_12052022",
//     transparent: true,
//     format: "image/png",
//   })
//   .addTo(map);
...
function handleLayer(layerName) {
  var layer = L.tileLayer.betterWms("http://engeosolucoes.com.br/geoserver/wms?", {
    layers: layerName,
    transparent: true,
    format: "image/png",
    zIndex: 1000,
